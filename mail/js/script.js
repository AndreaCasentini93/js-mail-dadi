...
var userMail = prompt("Insert your e-mail, please.");
...
if (k > 0) {
    document.getElementById("message").innerHTML = "Welcome! Your e-mail is on the guest list."
} else if (k == 0) {
    document.getElementById("message").innerHTML = "Sorry... Your e-mail isn't on the guest list."
}